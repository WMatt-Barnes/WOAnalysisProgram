...
# PyInstaller spec file for WO Analysis Program
# This spec file creates a single executable with all dependencies included
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=True,  # Set to True for debugging - can be changed to False later
