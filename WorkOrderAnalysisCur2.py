...
class FailureModeApp:
    ...
    def create_risk_assessment_tab(self):
        ...
        ttk.Label(prod_frame, text="Production Loss ($):", width=18).pack(side=tk.LEFT)
        ...
        ttk.Label(maint_frame, text="Maintenance Cost ($):", width=18).pack(side=tk.LEFT)
        ...
        ttk.Label(margin_frame, text="Margin ($/weight):", width=18).pack(side=tk.LEFT)
        ...
        ttk.Label(forecast_frame, text="Forecast Period (years):", width=18).pack(side=tk.LEFT)
        self.forecast_period_var = tk.StringVar(value="5")
        ttk.Entry(forecast_frame, textvariable=self.forecast_period_var, width=15).pack(side=tk.LEFT, padx=5)
...
map "Reported Date" to "date" in the dropdown."""
    ...
    def update_weibull_analysis(self):
        ...
        try:
            ...
            from WorkOrderAnalysisCur2 import calculate_crow_amsaa_params
            if isinstance(filtered_df, pd.DataFrame):
